...
Port provenance: ``wehoop:::helper_espn_wbb_player_box``
(``wehoop/R/espn_wbb_data.R`` lines 3481-3883, wehoop 3.0.0). Oracle:
``tests/fixtures/released/player_box_2025.parquet`` — the published
``espn_womens_college_basketball_player_boxscores`` asset pre-filtered to the
three 2025 fixture games (86 rows incl. DNP athletes). The helper ends in a
canonical ``dplyr::select`` so column ORDER is asserted (unlike pbp).
"""
