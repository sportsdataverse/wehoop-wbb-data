#!/bin/bash
# Process ESPN WBB datasets from wehoop-wbb-raw repo
# Usage: bash scripts/daily_wbb_R_processor.sh -s 2025 -e 2025
...
# the schedules + shots subsets; officials (09) reuses the game_rosters
# summary JSON. WBB has no draft.
SCRIPTS=(
...
do
    ...
    TMPLOG=$(mktemp "/tmp/wehoop_wbb_data_logfile_${i}.XXXXXX.log")
    echo "=== Processing WBB data for season $i ==="
